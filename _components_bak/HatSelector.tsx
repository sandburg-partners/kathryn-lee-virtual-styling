  ...
  return (
    <div className="relative" ref={wrapperRef}>
      <button
        ...
        className="w-full flex justify-between items-center px-3 py-2 border border-gray-300 rounded-md bg-white focus:outline-none focus:ring-brand-accent focus:border-brand-accent transition disabled:bg-gray-100 disabled:cursor-wait"
      >
        <span className="text-lg text-gray-700 truncate pr-2">{disabled ? 'Loading hats...' : placeholderText}</span>
